...
{
    typedef std::unordered_map<KeyType, typename std::conditional<shared, std::shared_ptr<ValueType>, ValueType>::type> DataType;
public:
...
class ConcurrentUnorderedMap<KeyType, ValueType, true>
{
    typedef std::unordered_map<KeyType, std::shared_ptr<ValueType>> DataType;
public:
