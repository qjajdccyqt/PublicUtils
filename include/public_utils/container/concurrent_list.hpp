...
{
    typedef std::list<typename std::conditional<shared, std::shared_ptr<ValueType>, ValueType>::type> DataType;
public:
...
class ConcurrentList<ValueType, true>
{
    typedef std::list<typename std::shared_ptr<ValueType>> DataType;
public:
