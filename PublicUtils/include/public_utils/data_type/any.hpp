...
//
//
// Copyright (c) 2016 Denilson das Merc阺 Amorim
//
...
private: // Storage and Virtual Method Table
    ...
    struct requires_allocation :
        ...
        !(std::is_nothrow_move_constructible<T>::value      // N4562 ?.3/3 [any.class]
...
namespace std
{
inline void swap(PublicUtils::any& lhs, PublicUtils::any& rhs) noexcept
{
    lhs.swap(rhs);
}
}
